...
<head>
  ...
  <link rel="stylesheet" href="${prefix}styles.css?v=20260903">
  ${schema}
</head>`;
}
...
function homePage() {
  const description = "Tirth Mody is an independent brand designer and cinematographer working across identity, packaging, social media, photography and content.";
  ...
  const steps = [["01", "I uncover your story", "I dig into what makes you irreplaceable and turn it into positioning with a clear point of view.", "Strategy & positioning", "media/step1.mp4"], ["02", "I bring it to life", "I plan, direct and shoot the work, carrying your idea seamlessly from concept through production.", "Production & direction", "media/step2.mp4"], ["03", "We put it to work", "I edit, design and finish every detail, then launch the work ready to connect and grow.", "Design & launch", "media/step3.mp4"]];
...
<section class="hero deep" aria-labelledby="hero-title"><div class="content hero-content">
  <p class="eyebrow">SleekDee / brand, graphic designer</p>
  ...
  <p class="hero-copy" data-blurline>I'm Tirth Mody, the brand and graphic designer and cinematographer behind SleekDee. Identities, feeds, packaging and photographs that pull their weight: work that looks good and sells harder.</p>
  <div class="hero-tags"><span class="desktop-label">brand, graphic designer</span><span class="mobile-label">brand, graphic designer</span><span>cinematographer</span></div>
