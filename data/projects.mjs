...
export const workItems = [
  { slug: "sapphire", number: "01", title: "sapphire coffee & culture", description: "A full identity and packaging range for a coffee house built around culture.", tags: ["Identity", "Packaging"], layout: "wide", images: ["assets/sapphire/sp-hero.png"], alts: ["Sapphire Coffee and Culture brand and packaging"] },
  { slug: "ernest-jones", number: "02", title: "ernest jones", description: "Two campaigns of post design — warm light, cold light, one piece in focus.", tags: ["Social", "Campaign"], layout: "wide", images: ["assets/ernest/ej-banner-1.png"], alts: ["Ernest Jones Circle of Light campaign banner"] },
  { slug: "woop", number: "03", title: "woop", description: "Brand identity, packaging and campaign for a good-time energy drink.", tags: ["Identity", "Packaging"], layout: "wide", images: ["assets/woop/wp-a.jpg"], alts: ["Woop energy drink cans on ice"] },
  { slug: "pringles", number: "04", title: "pringles conceptual ads", description: "Concept campaign, social posts and banner ads — flavour first, thumb-stopping.", tags: ["Social", "Concept"], layout: "triptych", images: ["assets/pringles/cover-11.jpg", "assets/pringles/cover-51.jpg", "assets/pringles/cover-45.jpg"], alts: ["Pringles Original concept ad", "Pringles Texas Barbecue concept ad", "Pringles Salt and Vinegar concept ad"] },
  { slug: "dr-pepper", number: "05", title: "dr pepper conceptual ads", description: "Concept campaign with one strong idea per flavour.", tags: ["Social", "Concept"], layout: "triptych", images: ["assets/dp/cover-01.jpg", "assets/dp/cover-08.jpg", "assets/dp/cover-04.jpg"], alts: ["Dr Pepper Cream Soda concept ad", "Dr Pepper Creamy Coconut concept ad", "Dr Pepper Strawberries and Cream concept ad"] },
  { slug: "interior-goods-direct", number: "06", title: "interior goods direct", description: "Instagram feed redesign — before and after, one premium visual language.", tags: ["Social", "Content"], layout: "wide", images: ["assets/igd/banner-1.webp"], alts: ["Interior Goods Direct Instagram feed redesign"] },
  { slug: "marshall", number: "07", title: "marshall", description: "Social media marketing and handling for a brand people already trust.", tags: ["Growth", "Social"], layout: "contain", images: ["assets/marshall/ms-19.png"], alts: ["Marshall social content and feed art direction"] },
  { slug: "prakriti-spice", number: "08", title: "prakriti spice", description: "Brand identity, packaging and a block-print system drawn from the spice table.", tags: ["Identity", "Packaging"], layout: "wide", images: ["assets/prakriti/pk-hero.png"], alts: ["Prakriti Spice brand identity and packaging"] }
];
